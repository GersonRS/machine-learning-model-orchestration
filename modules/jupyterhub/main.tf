...
resource "argocd_project" "this" {
  ...
  metadata {
    name      = var.destination_cluster != "in-cluster" ? "jupyterhub-${var.destination_cluster}" : "jupyterhub"
  ...
  spec {
    description  = "Jupyterhub application project for cluster ${var.destination_cluster}"
